...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:8E2DE2,50:4A00E0,100:00C9FF&height=120&section=header" width="100%"/>

<img src="docs/octa-banner-animated.svg" width="820" alt="OCTA AI animated banner"/>

<br/><br/>

<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=700&size=24&duration=2600&pause=800&color=00E5FF&center=true&vCenter=true&multiline=true&repeat=true&width=920&height=110&lines=%F0%9F%90%99+8+Arms.+1+Agent.+%240%2Fmonth+forever.;Discussion+%E2%86%92+Planning+%E2%86%92+Execution+%E2%86%92+Review+%E2%86%92+MCP;Security+Research+%7C+OSINT+%7C+Forensics+%7C+Bug+Bounty+%7C+Reporting;82%2C500%2B+Free+Cloud+Requests%2FDay+%2B+%E2%99%BE%EF%B8%8F+Unlimited+Local+Ollama" alt="typing-svg" />
...
[![Stars](https://img.shields.io/github/stars/lawcy0fficial/octa-ai?style=for-the-badge&logo=github&color=FFD700&labelColor=0d1117)](https://github.com/lawcy0fficial/octa-ai/stargazers)
[![Forks](https://img.shields.io/github/forks/lawcy0fficial/octa-ai?style=for-the-badge&logo=github&color=00C9FF&labelColor=0d1117)](https://github.com/lawcy0fficial/octa-ai/network/members)
[![Issues](https://img.shields.io/github/issues/lawcy0fficial/octa-ai?style=for-the-badge&logo=github&color=ff2e88&labelColor=0d1117)](https://github.com/lawcy0fficial/octa-ai/issues)
[![Last Commit](https://img.shields.io/github/last-commit/lawcy0fficial/octa-ai?style=for-the-badge&logo=github&color=39ff14&labelColor=0d1117)](https://github.com/lawcy0fficial/octa-ai/commits)
[![License](https://img.shields.io/badge/LICENSE-MIT-ff2e88?style=for-the-badge&labelColor=0d1117)](LICENSE)

[![Cost](https://img.shields.io/badge/COST-%240%2Fmonth-39ff14?style=for-the-badge&labelColor=0d1117)]()
...
[![Platform](https://img.shields.io/badge/PLATFORM-Parrot%20OS%20|%20Kali-8A2BE2?style=for-the-badge&logo=linux&logoColor=white&labelColor=0d1117)]()
[![APIs](https://img.shields.io/badge/FREE%20APIS-82,500%2B%20req%2Fday-FF6B00?style=for-the-badge&logo=lightning&logoColor=white&labelColor=0d1117)]()
[![MCP](https://img.shields.io/badge/MCP%20TOOLS-42-00FFAB?style=for-the-badge&logo=serverless&logoColor=white&labelColor=0d1117)]()
[![PRs](https://img.shields.io/badge/PRs-Welcome-ff69b4?style=for-the-badge&labelColor=0d1117)]()
[![Maintained](https://img.shields.io/badge/Maintained-Yes-success?style=for-the-badge&labelColor=0d1117)]()

<img src="https://capsule-render.vercel.app/api?type=rect&color=0:00C9FF,25:8E2DE2,50:ff2e88,75:00ff88,100:00C9FF&height=4&width=100%25" width="100%"/>
...
<img src="https://progress-bar.dev/100/?title=Cost%20Saved%20vs%20Paid%20APIs&width=280&color=39ff14"/>
<img src="https://progress-bar.dev/100/?title=Self-Taught%20%2F%20Non-CS%20Build&width=280&color=00d4ff"/>
...
<div align="center">
<img src="docs/octa-pipeline-animated.svg" width="820" alt="OCTA AI 4-phase agent loop animated"/>
</div>
...
```mermaid
flowchart TD
    U["🖥️ USER INPUT<br/>Open WebUI · Chainlit · CLI"] --> D

    subgraph PIPE [" 4-PHASE AGENT PIPELINE "]
        direction TB
        D["🧠 DISCUSSION<br/>OpenRouter ×10 · Cerebras ×9 · Grok ×9 · Gemini ×7"] --> P
        P["📋 PLANNING<br/>Fastest providers · Cerebras + Gemini"] --> E
        E["⚙️ EXECUTION<br/>LOCAL OLLAMA ONLY · Unlimited · Never Stops · Auto-fixes errors"] --> R
        R["✅ REVIEW<br/>All providers rotating · Quality polish"]
    end

    R --> M["🔗 MCP LAYER<br/>42 tools · Full Parrot OS access · Auto-install"]
    M --> O["📄 OUTPUT<br/>.py · .md · .pdf · .docx · .html"]

    style U fill:#0d1117,stroke:#00C9FF,stroke-width:2px,color:#fff
    style D fill:#1a1a3e,stroke:#8E2DE2,stroke-width:2px,color:#fff
    style P fill:#1a1a3e,stroke:#8E2DE2,stroke-width:2px,color:#fff
    style E fill:#2b0d3e,stroke:#ff2e88,stroke-width:2px,color:#fff
    style R fill:#1a1a3e,stroke:#8E2DE2,stroke-width:2px,color:#fff
    style M fill:#0d3e2b,stroke:#39ff14,stroke-width:2px,color:#fff
    style O fill:#0d1117,stroke:#FF6B00,stroke-width:2px,color:#fff
```
...
sequenceDiagram
    actor You
    participant UI as Open WebUI / Chainlit / CLI
    participant Agent as agent.py
    participant Cloud as Rotating Cloud Providers
    participant Ollama as Local Ollama
    participant MCP as mcp_master.py (42 tools)
    participant Mem as ChromaDB Memory

    You->>UI: Ask / task
    UI->>Agent: forward request
    Agent->>Mem: recall relevant context
    Agent->>Cloud: 🧠 Discussion phase
    Cloud-->>Agent: analysis
    Agent->>Cloud: 📋 Planning phase
    Cloud-->>Agent: execution blueprint
    Agent->>Ollama: ⚙️ Execution phase (looped)
    Ollama-->>Agent: code / results
    Agent->>MCP: run system tools as needed
    MCP-->>Agent: tool output
    Agent->>Cloud: ✅ Review phase
    Cloud-->>Agent: polished result
    Agent->>Mem: store new memory
    Agent-->>UI: stream final output
    UI-->>You: 📄 answer + report
```
...
```mermaid
graph LR
    K["🔑 keys.py<br/>base: keys + call_ai()"] --> A
    ME["🧠 memory.py<br/>base: ChromaDB"] --> A
    OU["📄 outputs.py<br/>base: PDF/MD/DOCX/HTML"] --> A

    K --> W["🔍 websearch.py<br/>search + CVE"]
    ME --> W
    W --> OS["🕵️ osint_agent.py"]
    W --> SP["🎨 specialized.py<br/>image + voice + data"]
    W --> SE["🔐 security_agent.py"]

    K --> A["🤖 agent.py<br/>main controller"]
    K --> B["🌉 bridge.py<br/>Open WebUI bridge"]
    K --> C["💬 chainlit_app.py"]
    ME --> C

    MCP["🔌 mcp_master.py<br/>42 Parrot OS tools"]

    style K fill:#0d1117,stroke:#FFD700,color:#fff
    style ME fill:#0d1117,stroke:#00C9FF,color:#fff
    style OU fill:#0d1117,stroke:#39ff14,color:#fff
    style A fill:#2b0d3e,stroke:#ff2e88,stroke-width:2px,color:#fff
    style MCP fill:#0d3e2b,stroke:#39ff14,stroke-width:2px,color:#fff
```
...
|:--|:--:|:--|:--|
| ![OpenRouter](https://img.shields.io/badge/-OpenRouter-6E56CF?style=flat-square) | ×10 | 56,000 req/day | Varies |
| ![Cerebras](https://img.shields.io/badge/-Cerebras-F5A623?style=flat-square) | ×9 | ~9M tokens/day | ⚡ 2,000 tok/s |
| ![Grok](https://img.shields.io/badge/-Grok%2FxAI-000000?style=flat-square) | ×9 | Large capacity | Fast |
| ![Gemini](https://img.shields.io/badge/-Gemini-4285F4?style=flat-square) | ×7 | 10,500 req/day | Fast (1M ctx) |
| ![Requesty](https://img.shields.io/badge/-Requesty-00C9A7?style=flat-square) | ×10 | 16,000 req/day | Fast |
| ![Novita](https://img.shields.io/badge/-Novita-FF6B6B?style=flat-square) | ×8 | Free tier | Fast |
| ![HuggingFace](https://img.shields.io/badge/-HuggingFace-FFD21E?style=flat-square) | ×1 | 2,000 req/day | Moderate |
| ![Ollama](https://img.shields.io/badge/-Ollama%20Local-39ff14?style=flat-square) | ♾️ | **UNLIMITED** | Local |

**🔥 Total: ~82,500+ requests/day, $0/month**

<img src="https://progress-bar.dev/100/?title=Monthly%20Bill&width=320&color=39ff14"/>
...
```mermaid
timeline
    title OCTA AI Roadmap
    v1.0 (Shipped) : 4-phase agent loop
                    : 42-tool MCP server
                    : ChromaDB memory
                    : Open WebUI + Chainlit
    Next            : Plan/Act/Observe loop upgrade
                    : SQLite session persistence
                    : Web dashboard for capacity
    Later           : Team / multi-agent handoff
...
![Chainlit](https://img.shields.io/badge/Chainlit-1C1C1C?style=for-the-badge)
![MCP](https://img.shields.io/badge/MCP-00FFAB?style=for-the-badge)
![ParrotOS](https://img.shields.io/badge/Parrot%20OS-4B0082?style=for-the-badge&logo=parrotsecurity&logoColor=white)
...
flowchart LR
    ...
    C --> D[🧪 Test]
    D --> E[📬 PR]
    style A fill:#161b22,stroke:#00d4ff,color:#fff
    style B fill:#161b22,stroke:#7c3aed,color:#fff
    style C fill:#161b22,stroke:#ff2e88,color:#fff
    style D fill:#161b22,stroke:#f59e0b,color:#fff
    style E fill:#161b22,stroke:#39ff14,color:#fff
```
...
[![GitHub](https://img.shields.io/badge/GitHub-lawcy0fficial-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/lawcy0fficial)
[![Portfolio](https://img.shields.io/badge/Portfolio-shibinoffi.github.io-00C9FF?style=for-the-badge&logo=googlechrome&logoColor=white)](https://shibinoffi.github.io)
...
<img src="https://api.star-history.com/svg?repos=lawcy0fficial/octa-ai&type=Date" width="600"/>
...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=700&size=20&pause=1000&color=FF6B00&center=true&vCenter=true&width=760&lines=%E2%9A%A1+OCTA+AI+%E2%80%94+8+Powers.+1+Agent.+%240%2Fmonth.+%E2%9A%A1;Built+solo%2C+self-taught%2C+for+the+security+research+community.;Star+it+%E2%AD%90+%7C+Fork+it+%F0%9F%8D%B4+%7C+Break+things+responsibly+%F0%9F%94%90" alt="footer-typing-svg" />
